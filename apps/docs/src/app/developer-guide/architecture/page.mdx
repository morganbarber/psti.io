...
This document provides an overview of SecurePaste's architecture, design decisions, and technical implementation.

## System Architecture

SecurePaste is built as a **monorepo** using Turborepo, containing multiple applications and shared packages.
...
SecurePaste implements multiple layers of security:
